...
def add_feature_set_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--pretrained-text-model", type=str, default="sbert")
    parser.add_argument("--pretrained-speech-model",type=str,default="wav2vec2")
...
def add_pca_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--systemf-text-pca", type=float, default=0.0)
    parser.add_argument("--speechf-text-pca", type=float, default=0.0)
    parser.add_argument("--speechf-wav-pca", type=float, default=0.0)
...
def add_lstm_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--num-layers", type=int, nargs='+', default=[1, 2, 3, 4])
    parser.add_argument("--lr", type=float, nargs='+', default=[0.001, 0.0005])
    parser.add_argument("--batch-size", type=int, nargs='+', default=[5, 15, 25])
